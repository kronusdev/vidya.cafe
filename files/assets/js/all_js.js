...
//GIFS
	...
	function loadEmojis(form, isUpdate) {
		...
		{
			type:'marsey',
			emojis: ['marseyjam','marseyhmm','marseyhmmm','marseythonk','marseyworried','marseysus','marsey4chan','marseyandmarcus','marseybluecheck','marseybong','marseybooba','marseyconfused','marseydespair','marseylizard','marseyowow','marseyproctologist','marseyvaxmaxx','marseyxd','marsoyhype','marmsey','marsey1984','marseyakshually','marseycope','marseydeux','marseydoomer','marseyflamewar','marseyfug','marseygasp','marseyglow','marseyhacker','marseyking','marseylawlz','marseylifting','marseymanlet','marseymaoist','marseymouse','marseyniqab','marseynpc','marseyorthodox','marseypainter','marseypeacekeeper','marseypickle','marseypipe','marseypirate','marseypope','marseyrat','marseyrick','marseyseethe','marseysneed','marseytaliban','marseytank','marseytankushanka','marseytroll','marseyunabomber','marseyvan','marsoy','marseyasian','marseyburger','marseyfacepalm','marseygrilling','marseyjanny','marseymermaid','marseyrentfree','marseyretard','marseysadcat','marseysick','marseysmug','marseytrain', 'marseysipping', 'marseyjamming','marseyangel','marseyblowkiss','marseycry','marseydead','marseyexcited','marseygift','marseyinabox','marseylaugh','marseylove','marseymad','marseyparty','marseyrain','marseyreading','marseyready','marseysad','marseyscarf','marseyshook','marseysleep','marseythumbsup','marseywave', 'marsey69', 'marseycomrade', 'marseyira', 'marseyisis', 'marseymerchant', 'marseynut', 'marseyreich', 'marseyglam', 'marseycowboy', 'marseypat', 'marseypanties', 'marseybingus', 'marseydepressed']
		},
		{
			type:'rage',
